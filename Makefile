...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
			config.c	connections.c hash.c queue.c worker.c \
		   	hash.h queue.h worker.h \
		   	client.c testconf.sh testfile.sh testleaks.sh teststress.sh \
		   	DATA/chatty.conf1 DATA/chatty.conf2 connections.h \
		   	Relazione.pdf script.sh

# inserire il nome del tarball: es. NinoBixio
TARNAME=GiulioPurgatorio
...
MAIL=g.purgatorio@studenti.unipi.it
#
###########################################################
...
#
###################################################################
UNIX_PATH       = /tmp/chatty_socket_516292
STAT_PATH       = /tmp/chatty_stats_516292.txt
DIR_PATH        = /tmp/chatty_516292
